...
router.post('/addDiscuss', function(req, res, next) {
  var discussObject = new Object();
  discussObject.dataYoutube = req.body.youtube;
  discussObject.dataId = req.body.subId;
  discussObject.dataDiscuss = req.body.discuss;
  discussObject.time = (new Date()).toISOString();
  firebase.addDiscuss(discussObject, function(data){
    res.send({result:discussObject.time})
  })
})
